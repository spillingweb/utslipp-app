...
const TilsynForm = ({ isOpen, setSelectedPoint, selectedPoint }: TilsynFormProps) => {
    ...
    const { setData, data, tilsynFormProperties, setTilsynFormProperties, storeTilsynObject, updateTilsynObject, processing, cancel } =
                ...
                <Form>
                    ...
                    {disabled && (
                        <div className={styles.cta}>
                            <Button onClick={handleStartEdit}>Rediger</Button>
                    ...
                    {!disabled && formMode == 'create' && (
                        <div className={styles.cta}>
                            <Button type="submit" onClick={handleSubmitForm} disabled={processing}>
